...
This tool is designed for computing network **link predictions** using a **Non negative Matrix Tri-Factorization (NMTF)** based method generalized to allow the use of networks of any topology. 
